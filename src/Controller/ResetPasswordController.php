...
class ResetPasswordController extends AbstractController
{
     ...
     */
    public function request(Request $request): Response     // public function request(Request $request, MailerInterface $mailer): Response
    {
            ...
            if (isset($user)) {
                ...
                if (isset($resetToken)) {
                    /*$emailsend = (new TemplatedEmail())
                        ->from(new Address('contact@omblies.com', 'Réinitialisation de mot de passe'))
                        ->to($user->getEmail())
                ...
                return $this->redirectToRoute("security_singin");
            }
        }
